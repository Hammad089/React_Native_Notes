...
const Todo = () => {
  ...
  const handleArrowClick = () => {
    ...
    Animated.timing(animationHeight, {
      toValue: showCompletedTasks ? 0 : hp(40), 
      duration: 300,
    ...
    <>
      <View style={{flex: 1, backgroundColor: '#fff'}}>
        ...
        {completedTodos.length > 0 && (
          <View style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center', margin:wp(5),top:-hp(30)}}>
            <Text>Completed Todo</Text>
            <TouchableOpacity onPress={handleArrowClick}>
              <Animated.View style={{transform: [{rotate: animationHeight.interpolate({inputRange: [0, 1], outputRange: ['0deg', '45deg']})}]}}>
                <RightArrowIcon />
              </Animated.View>
            </TouchableOpacity>
          </View>
